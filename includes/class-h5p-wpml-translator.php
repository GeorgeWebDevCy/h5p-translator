...
class H5p_Wpml_Translator {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      H5p_Wpml_Translator_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'H5P_WPML_TRANSLATOR_VERSION' ) ) {
			$this->version = H5P_WPML_TRANSLATOR_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'h5p-wpml-translator';
	 ...
	 *
	 * - H5p_Wpml_Translator_Loader. Orchestrates the hooks of the plugin.
	 * - H5p_Wpml_Translator_i18n. Defines internationalization functionality.
	 * - H5p_Wpml_Translator_Admin. Defines all hooks for the admin area.
	 * - H5p_Wpml_Translator_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-h5p-wpml-translator-loader.php';
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-h5p-wpml-translator-public.php';

		$this->loader = new H5p_Wpml_Translator_Loader();
	 ...
	 *
	 * Uses the H5p_Wpml_Translator_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new H5p_Wpml_Translator_i18n();
	 ...
	 *
	 * @since     1.0.0
	 * @return    H5p_Wpml_Translator_Loader    Orchestrates the hooks of the plugin.
	 */
