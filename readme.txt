...
= 1.2.27 =
* Add an admin-only string registration tool and stop auto-registration on render.
...
= 1.2.27 =
Register strings from the admin page instead of auto-registering on render.
